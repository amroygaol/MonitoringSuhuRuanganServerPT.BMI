<?php
	...
	include("connect.php");
	$result=mysql_query("SELECT * FROM `data_sensor` ORDER BY `timeStamp` DESC");
?>
<html>
	<head>
	...
	<body>
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<center><h3 style="text-align:right;" class="hijau tebel">Logging Sistem Monitoring Suhu Server</h3></center>
			</div>
			<div class="col-md-2">
				&nbsp;
			</div>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<center><h5 style="text-align:right;" class="miring">Data Logging</h5></center>
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
	...
	<script>
		var chart = new Highcharts.Chart({
			  ...
			  title: {
		            text: 'Grafik Data Suhu Server 1 Harian'
		        },
	...
	<script>
		var chart = new Highcharts.Chart({
			  ...
			  title: {
		            text: 'Grafik Data Suhu Server  Harian'
		        },
